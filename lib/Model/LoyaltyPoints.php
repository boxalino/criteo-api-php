 ...
 */
class LoyaltyPoints implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets points_value
     *
     * @param int|null $points_value The retailer's loyalty points in absolute value.
     *
     * @return self
     */
     ...
     * Sets ratio
     *
     * @param float|null $ratio The ratio of a point when converted to currency. Google assumes currency based on Merchant Center settings. If ratio is left out, it defaults to 1.0.
     *
     * @return self
     */
