 ...
 */
class AudienceSizeEntityV1Resource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AudienceSizeEntityV1Resource';
