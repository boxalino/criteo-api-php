 ...
 */
class AdSetTargetingVideoPositioningResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdSetTargetingVideoPositioningResource';
