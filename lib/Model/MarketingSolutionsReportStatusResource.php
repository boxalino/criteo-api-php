 ...
 */
class MarketingSolutionsReportStatusResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MarketingSolutionsReportStatusResource';
