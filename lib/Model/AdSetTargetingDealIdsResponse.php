 ...
 */
class AdSetTargetingDealIdsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdSetTargetingDealIdsResponse';
