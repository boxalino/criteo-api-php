 ...
 */
class ContactlistWithAttributesAmendment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactlistWithAttributesAmendment';
