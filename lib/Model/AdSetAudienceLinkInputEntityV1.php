 ...
 */
class AdSetAudienceLinkInputEntityV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdSetAudienceLinkInputEntityV1';
