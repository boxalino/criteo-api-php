 ...
 */
class LocationV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LocationV1';
    ...
    public const REGISTRY_TYPE_UNKNOWN = 'Unknown';
    public const REGISTRY_TYPE_POINT_OF_INTEREST = 'PointOfInterest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('radius_in_km', $data ?? [], null);
        $this->setIfExists('registry_type', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets radius_in_km
     *
     * @param int|null $radius_in_km The expected maximum distance in kilometers between a user and a point of interest
     *
     * @return self
     */
     ...
     * Sets registry_type
     *
     * @param string|null $registry_type The kind of Location audience
     *
     * @return self
     */
