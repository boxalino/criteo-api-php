 ...
 */
class AudienceSegmentCreateEntityV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AudienceSegmentCreateEntityV1';
