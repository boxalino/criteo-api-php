 ...
 */
class PatchAdSetCategoryBidResultListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchAdSetCategoryBidResultListResponse';
