 ...
 */
class AudienceSegmentComputeSizesInputV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AudienceSegmentComputeSizesInputV1';
