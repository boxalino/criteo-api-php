 ...
 */
class PointOfInterestV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PointOfInterestV1';
    ...
    */
     ...
     * Sets latitude
     *
     * @param float|null $latitude ISO-6709 latitude (rounded at 5 decimals)
     *
     * @return self
     */
     ...
     * Sets longitude
     *
     * @param float|null $longitude ISO-6709 longitude (rounded at 5 decimals)
     *
     * @return self
     */
