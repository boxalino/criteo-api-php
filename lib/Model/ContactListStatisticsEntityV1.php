...
class ContactListStatisticsEntityV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    {
        if (is_null($number_of_identifiers)) {
            throw new \InvalidArgumentException('non-nullable number_of_identifiers cannot be null');
        }
    ...
    public function setMatchRate($match_rate)
    {
        if (is_null($match_rate)) {
            throw new \InvalidArgumentException('non-nullable match_rate cannot be null');
        }
