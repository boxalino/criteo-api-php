...
/**
 * AdSetTargetingDealIds Class Doc Comment
 *
 * @category Class
 ...
 */
class AdSetTargetingDealIds implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdSetTargetingDealIds';
    ...
    {
        $this->setIfExists('deal_ids', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($deal_ids)) {
            throw new \InvalidArgumentException('non-nullable deal_ids cannot be null');
        }
