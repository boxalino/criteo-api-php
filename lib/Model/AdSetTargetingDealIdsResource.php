 ...
 */
class AdSetTargetingDealIdsResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdSetTargetingDealIdsResource';
