 ...
 */
class ApplicationSummaryModelResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplicationSummaryModelResponse';
