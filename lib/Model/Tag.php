...
class Tag implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('html_tag', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['html_tag'];
    }
    ...
    {
        if (is_null($html_tag)) {
            throw new \InvalidArgumentException('non-nullable html_tag cannot be null');
        }
        $this->container['html_tag'] = $html_tag;
