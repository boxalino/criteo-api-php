 ...
 */
class AudienceEstimateSizeEntityV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AudienceEstimateSizeEntityV1';
