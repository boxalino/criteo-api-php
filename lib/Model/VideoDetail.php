...
class VideoDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets duration
     *
     * @param float $duration The duration of the video in milliseconds, the video could be trimmed if it is longer than 30000 ms.
     *
     * @return self
     */
     ...
     * Sets shape
     *
     * @param string $shape Shape of the video
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string $url URL of the video uploaded on demostatic.criteo.com when deploying and then static.criteo.net
     *
     * @return self
     */
