 ...
 */
class OnSiteRecoResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OnSiteRecoResponse';
    ...
    */
    ...
    {
        if (is_null($extra_infos)) {
            throw new \InvalidArgumentException('non-nullable extra_infos cannot be null');
        }
