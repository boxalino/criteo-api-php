 ...
 */
class PatchAdSetDisplayMultiplierListRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchAdSetDisplayMultiplierListRequest';
